...
anya = User.create(username: "anya", email: "anya@anya.com", password: "anya", password_confirmation: "anya", affiliation: "uchicago", age: 24)
...
suviage = Datapoint.create(value: "100+ years", language_id: 1, feature_id: 2, user_id: 1)
